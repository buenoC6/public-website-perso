        ...
        return [{
            ...
            headers:[{
                ...
                value:"" +
                    ...
                    " base-uri 'none';" +
                    " form-action 'self';" +
                    " script-src 'self' https://matomo.alexianmoins.be https://client.axept.io https://static.axept.io;" +
                    ...
                    " script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' https://static.axept.io https://netbuddies.be;"
            }]
        }]
    },
    async redirects() {
